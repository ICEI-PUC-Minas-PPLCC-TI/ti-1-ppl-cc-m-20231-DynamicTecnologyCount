...
var tabelaTecnicosEnfermagem = document.querySelector(
  '.tabela-tecnicos-enfermagem'
);
...
function buscar() {
  ...
  var linhasTecnicos = document.querySelectorAll(
    '.tabela-tecnicos-enfermagem .linha'
  );
